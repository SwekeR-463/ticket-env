    ...
    def _parse_user_prompt(self, prompt: str):
        ...
        for concert in self.base_prices:
            if concert == selected_concert:
                ...
                self.user_preferences[concert] = 20  # not interested
...
# Simulate 5 turns with user selecting Coldplay
for _ in range(5):
    traffic = {
    ...
    user_prompt = "I want to buy Coldplay tickets"
    pricing.simulate_purchase(user_prompt, traffic)
